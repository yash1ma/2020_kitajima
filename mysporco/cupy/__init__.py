...
try:
    ...
    sys.stderr.write('The mysporco.cupy subpackage is not supported under '
                     'Python 2.7\n')
    raise
...
def sporco_cupy_patch_module(name, attrib=None):
    ...
    # by replacing 'mysporco.' with 'mysporco.cupy.'
    pname = re.sub('^mysporco.', 'mysporco.cupy.', name)
    print(pname)
...
util = sporco_cupy_patch_module('mysporco.util', {'list2array': _list2array})

# Construct sporco.cupy.metric
metric = sporco_cupy_patch_module('mysporco.metric')

# Construct sporco.cupy.common
common = sporco_cupy_patch_module('mysporco.common')

# Construct sporco.cupy.cnvrep
cnvrep = sporco_cupy_patch_module('mysporco.cnvrep')
